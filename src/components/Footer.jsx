...
const Footer = () => {
  ...
  return (
    <div className='border-t-richblack-500 border-t-[1px]'>
        <footer className="relative bg-blueGray-200 pt-8 pb-6 bg-richblack-900 text-white font-thin">
            <div className="container mx-auto px-4">
                ...
                <div className="w-full md:w-4/12 px-4 mx-auto text-center">
                    ...
                    <a href="https://www.creative-tim.com?ref=njs-profile" className="text-blueGray-500 hover:text-blueGray-800"> - ReelVortex</a>
                    </div>
                </div>
                </div>
            </div>
