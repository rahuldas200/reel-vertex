...
const SignIn = () => {
  ...
  return (
    <>
      <Navbar/>
      <section className="h-full w-10/12 mx-auto min-h-screen max-sm:w-11/12">
      
        <div className="h-full ">
          {/* <!-- Left column container with background--> */}
          <div className="gap-6 flex p-10 max-sm:p-0 mt-5 h-full flex-wrap items-center justify-center lg:justify-between">
            ...
            <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12 bg-richblack-300 p-5 max-sm:p-3 rounded-md">
              <form>
                ...
                <div className="flex flex-col gap-4">
                  <input
                  type="email"
                  className="bg-black px-5 py-3 w-full text-white rounded-md"
